  ...
  getMovieListData: function (typeId) {
    ...
    wx.request({
      ...
      success: function (res) {
        var subjects = res.data.movieList;
        ...
        for (let idx in movieList) {
          var subject = movieList[idx];
          var directors = "";
          ...
          var temp = {
            ...
            title: subject.nm,
            rating: subject.sc+"分",
            collectCount: subject.wish,
            images: subject.img.replace("/w.h",'/80.120'),
            subtype: subject.subtype,
            directors: directors,
            genres: genres,
            casts: subject.star.split(",").join("/"),
            typeId: typeId,
            year: subject.rt
          };
          movies.push(temp);
